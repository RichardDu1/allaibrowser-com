...
const industries = ["AI Chrome Extensions", "Web Surfing Copilots", "AI Search Engines", "Browser-based Automation", "AI Writing Assistants"];
...
async function generateSeedTopicsBatch(batchSize = 20) {
  ...
  const prompt = `
You are a Web AI Extension Expert for AllAIBrowser. Focus on browser integration, ease of use, data privacy, tab memory management, and search efficiency.
